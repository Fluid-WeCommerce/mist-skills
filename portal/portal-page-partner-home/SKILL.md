---
name: Create a partner home page
description: Create the everyday partner/rep home page in the portal — hero, share kit, ready-to-post content, community proof, aspirational closer. Use when asked to add or build a home page, rep home, partner home, or daily driver page.
icon: house
category: Portal
preview: hero,droplet,header,split-left,header,tiles3,panels3,header,tiles3
---

# Create a partner home page

Creates the **Home — Daily driver** page in a FluidOS portal for a partner/rep who opens the portal daily.

Suggested slug: `home` · The page a partner/rep opens every day: hero, share tools, ready-to-post content, community proof, aspirational closer.

The finished layout, top to bottom:

- CarouselWidget _(Welcome back. Let's make today count.)_
- Stories _(Fresh advice from the team)_
- **HEADER** · `YOUR TOOLKIT` — One link. Everything follows.
- **ROW [2c-left-wider]** → QuickShareWidget · LayoutWidget · ListWidget · LinkWidget · LayoutWidget
- **HEADER** · `CONTENT` — Tonight's post, done.
- ListWidget _(6 items, 3 col)_
- **ROW [3c-equal]** → MakeAVideoCta · VideoWidget · VideoWidget
- **HEADER** · `COMMUNITY` — Proof in the wild.
- ListWidget _(3 items, 3 col)_
- CarouselWidget _(Affiliate. Builder. Coach. Director.)_
...
2. **Create the screen shell**, then PUT the tree — the POST requires
   ...
   POST .../definitions/<DEF_ID>/screens
     { "screen": { "name": "<Page name>", "slug": "home", "component_tree": {} } }
...
4. **Add a nav item** pointing at the new screen, including a `slug` —
   ...
   POST .../navigations/<NAV_ID>/navigation_items
     { "navigation_item": { "label": "<Label>", "slug": "home",
