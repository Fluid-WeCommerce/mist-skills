...
2. Call `fluid_api("/api/v202506/orders?filter[created_at_gte]=<90-days-ago>&limit=100", "GET")`, paginating until exhausted. Tally units sold per product over the trailing 90 days.
