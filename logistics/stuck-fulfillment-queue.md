...
1. Call `fluid_api("/api/v202506/orders?filter[order_status]=completed&limit=100", "GET")`, paginating until exhausted. Keep `id`, `order_number`, `amount`, `created_at`, `sale_date`, `fulfillment_status`, `status`, `first_item`, `items_count`.
